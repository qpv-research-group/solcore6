...
from solcore.parameter_sources import BuiltinNKSource
...
class TestBuiltinNKSource(NKSourceTestSuite):
    ...
    def test_get_nk(self):
        from solcore.parameter import InputArgumentMissing
    ...
    def test_load_alloy(self, tmp_path):
        ...
        package = "solcore.parameter_sources.tools.critical_point_interpolate"
