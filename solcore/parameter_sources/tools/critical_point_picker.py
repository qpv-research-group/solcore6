...
class CPPicker:
    """This class can be used to pick the critical points out of n and k curves

    For a range of compositions in ternary alloys. Later, this critical points
...
if __name__ == "__main__":
    directory = "path to folder with n or k data"
    pickerApp = CPPicker(directory)
    pickerApp.loop()
